...
constructor(
    ...
    private val PREF_THEME by lazy { stringPreferencesKey(KEY_THEME) }
    ...
    override suspend fun setPreferredTheme(preferredTheme: String) {
        set(key = PREF_THEME, value = preferredTheme)
    }

    override suspend fun getPreferredTheme(): Flow<String> {
        return get(
            key = PREF_THEME,
