...
import com.tommunyiri.saftechweather.presentation.components.PermissionRationaleDialog
...
@Composable
fun Activity.OnPermissionDenied(activityPermissionResult: ActivityResultLauncher<String>) {
